...
function Dashboard({ autor }: Props) {
  ...
  const onDragEnter = (boardId: number, cardId: number) => {
    ...
    console.log(cardId)
    if (targetCard.cardId === cardId && targetCard.boardId === boardId) return;
    setTargetCard({
      boardId: boardId,
      cardId: cardId,
  ...
  return (<>
    ...
    <div className="app">
      <div className="app-nav">
        <h1 className='main-title'>Канбан доска. Комаров М.С. Ссылка на мой репозиторий:https://github.com/My-mind-is-open/Resume</h1>
